  ...
  return (
    <>
              ...
              <div className="quickbuy-body">
                ...
                <div className="quickbuy-form">
                  <div className="qfield">
                    ...
                    <input className={`qinput${submitted && errors.name ? " error" : ""}`} type="text" placeholder="Enter your full name" value={customer.name} onChange={(e) => update("name", e.target.value)} onBlur={() => blur("name")} />
                    {submitted && errors.name && <span className="qerror">{errors.name}</span>}
                  </div>
                  <div className="qfield">
                    <label className="qlabel">Phone *</label>
                    <input className={`qinput${submitted && errors.phone ? " error" : ""}`} type="tel" placeholder="e.g. +1 555 123 4567" value={customer.phone} onChange={(e) => update("phone", e.target.value)} onBlur={() => blur("phone")} />
                  ...
                  <div className="qfield">
                    ...
                    {customer.delivery === "delivery" ? (
                      <>
                        <input className={`qinput${submitted && errors.address ? " error" : ""}`} type="text" placeholder="Street, city, zip code" value={customer.address} onChange={(e) => update("address", e.target.value)} onBlur={() => blur("address")} />
                  ...
                  <div className="qfield">
                    ...
                    {customer.payment === "Other" && (
                      <>
                        <input className={`qinput${submitted && errors.paymentOther ? " error" : ""}`} type="text" placeholder="Describe your payment method" value={customer.paymentOther} onChange={(e) => update("paymentOther", e.target.value)} onBlur={() => blur("paymentOther")} style={{ marginTop: "0.5rem" }} />
      ...
      <style jsx global>{`
        ...
        .quickbuy-btn-primary:hover:not(:disabled) {
